...
public interface EpProductDAO {
    String SELECT_FIELDS = " a.iproductid,a.vcuniversalname title,a.vcproductcode,a.vcuniversalname,a.vcproductname,a.vceasycode,a.vcstandard,a.vcmanufacturer,c.unitname,d.numprice";
