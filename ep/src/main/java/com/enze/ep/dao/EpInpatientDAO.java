...
public interface EpInpatientDAO {
	...
	String SELECT_FIELDS = " inid,hisinid,name, idcard,age,bedno,sectionid,describe,memo,usestatus,address,name+'|'+bedno+'|'+address title ";

	@Insert({ "insert into ", TABLE_NAME, "(", INSET_FIELDS,
			") values (#{hisinid},#{name},#{idcard},#{age},#{bedno},#{sectionid},#{describe},#{memo},#{usestatus},#{address})" })
